    ...
    def _enqueue(self) -> bool:
        try:
            self.Queue.enqueue(
                ...
                DelayStep(step='Waiting 15s',
                        min_val=15, max_val=16),
                ...
                DelayStep(step='Waiting 2s',
                        min_val=2, max_val=3),
                MoveStep(step='Move to group-select button',
                        terminate=self.config.browser.coord.group_select),
                DelayStep(step='Waiting 1s',
                        min_val=1, max_val=2),
                ClickStep(step='Click group-select button'),
                MoveStep(step='Move to group-click button',
                        terminate=self.config.browser.coord.group_click),
                DelayStep(step='Waiting 1s',
                        min_val=1, max_val=2),
                ClickStep(step='Click group-click button'),
                DelayStep(step='Waiting 2s',
                        min_val=2, max_val=3),
                
                MoveStep(step='Move to name-select button',
                        terminate=self.config.browser.coord.name_select),
                DelayStep(step='Waiting 1s',
                        min_val=1, max_val=2),
                ClickStep(step='Click name-select button'),
                DelayStep(step='Waiting 1s',
                        min_val=1, max_val=2),
                MoveStep(step='Move to name-click button',
                        terminate=self.config.browser.coord.name_click),
                DelayStep(step='Waiting 1s',
                        min_val=1, max_val=2),
                ClickStep(step='Click name-click button'),
                DelayStep(step='Waiting 1s',
                        min_val=1, max_val=2),
                MoveStep(step='Move to name-bar',
                        terminate=self.config.browser.coord.name_bar),    
                DelayStep(step='Waiting 1s',
                        min_val=1, max_val=2),
                ClickStep(step='Click name-bar'),
                HotkeyStep(step='Ctrl+A',
                        keys=['ctrl','a']),
                DelayStep(step='Waiting 1s',
                        min_val=1, max_val=2),
                PasteStep(step='Paste name-bar',
                        text=self.config.browser.coord.name_in),
                
                MoveStep(step='Move to add-bar1',
                        terminate=self.config.browser.coord.add_bar1),
                DelayStep(step='Waiting 1s',
                        min_val=1, max_val=2),
                ClickStep(step='Click add-bar1'),
                MoveStep(step='Move to value-select button',
                        terminate=self.config.browser.coord.value_select),
                DelayStep(step='Waiting 1s',
                        min_val=1, max_val=2),
                ClickStep(step='Click value-select button'),
                DelayStep(step='Waiting 1s',
                        min_val=1, max_val=2),
                MoveStep(step='Move to value-click button',
                        terminate=self.config.browser.coord.value_click),
                DelayStep(step='Waiting 1s',
                        min_val=1, max_val=2),
                ClickStep(step='Click value-click button'),
                DelayStep(step='Waiting 1s',
                        min_val=1, max_val=2),
                MoveStep(step='Move to value-bar',
                        terminate=self.config.browser.coord.value_bar),
                ClickStep(step='Click value-bar'),
                HotkeyStep(step='Ctrl+A',
                        keys=['ctrl','a']),
                DelayStep(step='Waiting 1s',
                        min_val=1, max_val=2),
                PasteStep(step='Paste value-bar',
                        text=self.config.browser.coord.value_in),
                
                MoveStep(step='Move to add-bar2',
                        terminate=self.config.browser.coord.add_bar2),
                DelayStep(step='Waiting 1s',
                        min_val=1, max_val=2), 
                ClickStep(step='Click add-bar2'),
                MoveStep(step='Move to desc-select button',
                        terminate=self.config.browser.coord.desc_select),
                DelayStep(step='Waiting 1s',
                        min_val=1, max_val=2),
                ClickStep(step='Click desc-select button'),
                DelayStep(step='Waiting 1s',
                        min_val=1, max_val=2),
                MoveStep(step='Move to desk-click button',
                        terminate=self.config.browser.coord.desc_click),
                DelayStep(step='Waiting 1s',
                        min_val=1, max_val=2),
                ClickStep(step='Click desc-click button'),
                DelayStep(step='Waiting 1s',
                        min_val=1, max_val=2),
                MoveStep(step='Move to desc-bar',
                        terminate=self.config.browser.coord.desc_bar),
                DelayStep(step='Waiting 1s',
                        min_val=1, max_val=2),
                ClickStep(step='Click desc-bar'),
                HotkeyStep(step='Ctrl+A',
                        keys=['ctrl','a']),
                DelayStep(step='Waiting 1s',
                        min_val=1, max_val=2),
                PasteStep(step='Paste desc-bar',
                        text=self.config.browser.coord.desc_in),
                
                MoveStep(step='Move to add-bar3',
                        terminate=self.config.browser.coord.add_bar3),
                DelayStep(step='Waiting 1s',
                        min_val=1, max_val=2),
                ClickStep(step='Click add-bar3'),
                MoveStep(step='Move to source-select button',
                        terminate=self.config.browser.coord.source_select),
                DelayStep(step='Waiting 1s',
                        min_val=1, max_val=2),
                ClickStep(step='Click source-select button'),
                DelayStep(step='Waiting 1s',
                        min_val=1, max_val=2),
                MoveStep(step='Move to source-click button',
                        terminate=self.config.browser.coord.source_click),
                DelayStep(step='Waiting 1s',
                        min_val=1, max_val=2),
                ClickStep(step='Click source-click button'),
                DelayStep(step='Waiting 1s',
                        min_val=1, max_val=2),
                MoveStep(step='Move to source-bar',
                        terminate=self.config.browser.coord.source_bar),
                DelayStep(step='Waiting 1s',
                        min_val=1, max_val=2),
                ClickStep(step='Click source-bar'),
                HotkeyStep(step='Ctrl+A',
                        keys=['ctrl','a']),
                DelayStep(step='Waiting 1s',
                        min_val=1, max_val=2),
                PasteStep(step='Paste source-bar',
                        text=self.config.browser.coord.source_in),
                
                MoveStep(step='Move to confirm button',
                        terminate=self.config.browser.coord.confirm),
                DelayStep(step='Waiting 1s',
                        min_val=1, max_val=2),
                ClickStep(step='Click confirm button'),
                DelayStep(step='Waiting 1min',
                        min_val=60, max_val=66),
                
                MoveStep(step='Move to export button',
                        terminate=self.config.browser.coord.export),
                DelayStep(step='Waiting 1s',
                        min_val=1, max_val=2),
                ClickStep(step='Click export button'),
                DelayStep(step='Waiting 1s',
                        min_val=1, max_val=2),
                MoveStep(step='Move to export_csv button',
                        terminate=self.config.browser.coord.export_csv),
                DelayStep(step='Waiting 1s',
                        min_val=1, max_val=2),
                ClickStep(step='Click export_csv button'),
                DelayStep(step='Waiting 2s',
                        min_val=2, max_val=3),
